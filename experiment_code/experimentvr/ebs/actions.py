...
def detach_volume(region: str = None,
    ...
    parameters = {
        ...
        'volumeId': [
            get_ebs_volume_by_tag(tag_key_1, tag_value_1, tag_key_2, tag_value_2, 'VolumeId')
        ],
        'device': [
            get_ebs_volume_by_tag(tag_key_1, tag_value_1, tag_key_2, tag_value_2, 'Device')
        ]
    }
    ...
    try:
        response = ssm.send_command(DocumentName = 'DetachVolume',
