...
def blackhole_by_url(targets: List[str] = None,
                         test_target_type: str = 'RANDOM',
                         tag_key: str = None,
                         tag_value: str = None,
    ...
    try:
        ssm.send_command(InstanceIds = test_instance_ids,
                         CloudWatchOutputConfig = {"CloudWatchOutputEnabled": True},
...
def blackhole_secrets_manager(targets: List[str] = None,
					 					 test_target_type: str ='RANDOM',
					 					 tag_key: str = None, 
                     tag_value: str = None, 
                     region: str = 'us-east-1',
	...
	secrets_manager_ip_ranges = get_ip_ranges(region = 'us-east-1',
                      						 managed_service = 'secretsmanager')
