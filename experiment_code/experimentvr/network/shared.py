...
def get_ip_ranges(region: str = None, 
                managed_service: str = 'S3'):

    function_name = sys._getframe(  ).f_code.co_name

    ip_ranges = requests.get('https://ip-ranges.amazonaws.com/ip-ranges.json').json()['prefixes']
    managed_service_ips = [item['ip_prefix'] for item in ip_ranges if item["service"] == managed_service]
    ...
    print(function_name, "(): managed_service_region_ips_str = ", managed_service_region_ips_str)
